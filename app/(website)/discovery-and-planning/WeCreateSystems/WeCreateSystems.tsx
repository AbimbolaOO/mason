...
const WeLeverageTechnology = () => {
  return (
    <div className='flex-col flex gap-12 max-md:gap-6 pb-[86px] max-md:pb-4 max-md:pt-10 max-md:items-center max-md:justify-center text-white bg-mason-black px-20 items-center h-[calc(100vh-88px)] max-md:h-fit'>
